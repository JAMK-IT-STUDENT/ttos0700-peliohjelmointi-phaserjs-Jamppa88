...
demo.state6.prototype = {
  preload: function(){
    ...
    game.load.image('yeBall', './assets/sprites/yellowball.png');
  },
  create: function(){
    game.stage.backgroundColor = '#cc6699';
    addChangeStateEventListeners();

    game.add.sprite(centerX - 30, 660, 'volcano').anchor.setTo(0.5, 1);
    var emitter = game.add.emitter(centerX, 500, 2000);
    emitter.makeParticles(['redBall', 'yeBall'], 0, 5000, false, true);
